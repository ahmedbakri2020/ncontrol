...
if ($_POST['action'] == 'edit') {
    ...
    $obj->update();
       ...
       $res_check_data = $obj->db->query("select * from reelection_display where election_type='$etype' and province='$eprovince' and district='$edistrict' and const='$econstituency' and group_id='$egroup'");
      if($res_check_data->rowCount()>0):
        $obj->tbl = "reelection_display";
        $obj->val = array(
        "election_type"=>$etype,
        "province"=>$eprovince,
        "district"=>$edistrict,
    ...
    $obj->redirect('?page=recandidates');
