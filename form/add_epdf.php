...
if (isset($_GET['id'])) {
    $action = "edit";
    $id = (int) $_GET['id'];
    $row = $obj->getDataByField("epaper_pdf", 'eid', $id);
...
<form method="post" action="?fol=actpages&amp;page=act_adedepdf" enctype="multipart/form-data" id="form-data">
    <div class="row">
            ...
            <article class="module">
                ...
                <section>
                    <div class="bs-multiselect">
                        <ul>
                            <?php
                            $res_news_type = $obj->select(epaper_cat, "*");
                   ...
                   if ($action == 'add') {
                    ...
                    ?> id="thumbnail" data-toggle="modal" data-target=".bs-modal-lg">
                        <?php //if (isset($row) && $row['epaper_image'] != ""): ?>
                            <img src="../uploads/paper/pdf/thumbs/<?php echo $row['epaper_image']; ?>">
                        <?php //endif; ?>
                    </div>
                    <div class="form-group">
