                ...
                <section>
                    ...
                    <div class="form-group">
                        <label for="content-editor">Content</label>
                         <strong class="error-space"></strong>
            ...
            <article class="module margin-top">
                ...
                <section>
                    ...
                    <div class="bs-upload-image" id="thumbnail" data-toggle="modal" data-target=".bs-modal-lg">
                        ...
                        <?php } elseif (isset($row) && $row['img_path'] != "") {
                            ?>
               ...
               <article class="module margin-top">
                <header><h2>Print/Digital</h2></header>
                <section>
                    <div class="form-group" id="sub_cat">
                        <label for="Subnews">Print/Digital</label>
                        <select name="p_type" id="" class="form-control">
                            <option selected>----Select---</option>
                                <option value ="1" <?php if (isset($row) && $row['p_type'] == 1) echo 'selected'; ?>> प्रिन्ट संस्करण</option>
                                  <option value ="2" <?php if (isset($row) && $row['p_type'] == 2) echo 'selected'; ?>> डिजिटल संस्करण</option>
                        </select>

                    </div>
                     <div class="form-group">
                                        <label for="author">Trending Keyword</label>
                                        <select id="newsTrend" name="trend" class="form-control">

                                            <option value="">--Select One--</option>
                                            <?php
                                            if($res_trend==true){
                                                while ($row_trend = $res_trend->fetch()):
                                                    ?>
                                                    <option value="<?php echo $row_trend['cat01id'] ?>" <?php if (isset($row) && $row_trend['cat01id'] == $row['trend']) echo 'selected'; ?>><?php echo $row_trend['cat01category'] ?></option>
                                                <?php endwhile; } ?>
                                        </select>
                                    </div>
