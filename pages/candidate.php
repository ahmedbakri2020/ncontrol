...
">Election Hide</button>';
            ...
            ?>
        <a href="?fol=form&page=add-candidate&type=<?php echo $type; ?>" title=""><i class="fa fa-plus"></i> Add Candidate</a>
...
<script type="text/javascript">
 $('document').ready(function() {
    ...
    $('.pagination').on('click', 'a', function(e) {
        ...
        $.ajax({
            url: '<?php echo ADMIN_URL ?>ajax/pagination-candidate.php',
            type: 'POST',
            data: data,
            dataType: 'json',
    ...
    $('#filter-dat').on('submit', function (e) {
       ...
       // showSpinner();
        ...
        $.ajax({
            type: "POST",
            url: 'ajax/pagination-candidate.php',
            data: data,
            dataType: 'json',
            success: function (response)
            {
    ...
    function updateVote(id) {
        ...
        // alert(value);
        $.ajax({
            url: "ajax/update-vote-count.php",
            type: "post",
