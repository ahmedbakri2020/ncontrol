...
$res_user_cat = $obj->select("epaper_new_cat", "*");
if ($obj->getREQUEST('cat_id') && (int) $_GET['cat_id'] != "") {
    $cat = 'category';
    $type = (int) $_GET['cat_id'];
    $rowType = $obj->getDataByField("epaper_new_cat", 'cat01id', $type);
    $title = $rowType['cat01category'];
    $add_url = '?fol=form&amp;page=add_nepdf';
} else {
    $title = 'All PDF';
    $type = 0;
    $cat = 'all';
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <div class="input-group">
                                <select class="form-control" name="category" onchange="window.location = '?page=epaper-new-pdf&cat_id=' + this.value">
