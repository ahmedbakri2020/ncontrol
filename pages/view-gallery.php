...
if ($obj->getREQUEST('type') && (int) $_GET['type'] != "") {
    $cat = 'category';
    $type = (int) $_GET['type'];
    $rowType = $obj->getDataByField(GALLERY,'uin',$type);
    $title = $rowType['g01title'];
} else {
    $title = 'Photo Gallery';
    $type = 0;
    $cat = 'latest';
...
<article class="module">
    <header>
        ...
        <a href="?fol=form&amp;page=add-images&type=<?php echo $type ?>" title=""><i class="fa fa-plus"></i> Add Photo</a>
    </header>
    <section>
