...
$res_user_cat = $obj->select("epaper_turn_cat", "*");
if ($obj->getREQUEST('cat_id') && (int) $_GET['cat_id'] != "") {
    $cat = 'category';
    $type = (int) $_GET['cat_id'];
    $rowType = $obj->getDataByField("epaper_turn_cat", 'cat01id', $type);
    $title = $rowType['cat01category'];
    $add_url = '?fol=form&amp;page=add_turn';
} else {
    $title = 'All PDF';
    $type = 0;
    $cat = 'all';
...
?>
    <article class="module">
        <header><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
            ...
            <a href="<?php echo $add_url ?>&action=add" title=""><i class="fa fa-plus"></i> Add Epaper</a>
        </header>
        <section>
                    ...
                    <!--<div class="col-md-4">
                        <div class="form-group">
                            <div class="input-group">
                                <select class="form-control" name="category" onchange="window.location = '?page=epaper-turn&cat_id=' + this.value">
