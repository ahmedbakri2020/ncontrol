                            ...
                            <table class="table table-hover" id="news-table">
                                ...
                                <tbody>
                                    ...
                                    while ($ras = $res[0]->fetch()) {
                                        ...
                                        $img_name = SITE_URL . "epaper/images/" . $ras['paper_loc'];
                                        //  var_dump($img_name);
            ...
            <article class="module">
                ...
                <section>
                    <form method="post" enctype="multipart/form-data" action="?fol=actpages&page=act_adedpaper">
                        ...
                        <input type="hidden" value="<?php echo $count_query + 1; ?>"  name="image_name" class="form-control"  id="Image"/>
